...
class ControllerActions():
    ...
    def open_playlist(self, event=None):
        ...
        file_path = filedialog.askopenfilename(
            ...
            filetypes=filetypes,
            initialdir="G:\\Playlists\\Erev Playlists"  # Start in the home directory
        )
        if file_path:
    ...
    def save_current_playlist_as(self, event=None):
        ...
        file_path = filedialog.asksaveasfilename(
            ...
            initialdir=os.path.dirname(playlist.path) if playlist.path else "G:\\Playlists\\Erev Playlists" # Start in the home directory
        )
        if file_path:
