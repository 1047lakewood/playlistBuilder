...
class MetadataEditDialog(simpledialog.Dialog):
    ...
    def body(self, master):
        ...
        title_entry = tk.Entry(master, textvariable=self.title_var, font=DEFAULT_FONT)
        title_entry.grid(row=0, column=1, sticky="ew")
        self.artist_combo = ttk.Combobox(master, textvariable=self.artist_var, values=self.intro_artists, font=DEFAULT_FONT, state="normal")
    ...
    def _load_intro_artists(self):
        ...
        intro_dir = "G:\\Shiurim\\IntrosCleanedUp\\"
        artists = set()
